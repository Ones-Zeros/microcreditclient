...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKBRANCH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_BANKBRANCHES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BANKBRANCH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BANKBRANCH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BANKBRANCH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BANKBRANCH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BANKBRANCH actions', async () => {
      const arg = 42666;
