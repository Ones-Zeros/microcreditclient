...
import { deleteEntity, getEntity } from './bank.reducer';
...
export const BankDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="microcreditclientApp.bank.delete.question">
        <Translate contentKey="microcreditclientApp.bank.delete.question" interpolate={{ id: bankEntity.id }}>
