...
import { getEntities, searchEntities } from './bank.reducer';
  ...
  return (
    <div>
      <h2 id="bank-heading" data-cy="BankHeading">
        <Translate contentKey="microcreditclientApp.bank.home.title">Banks</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="microcreditclientApp.bank.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/bank/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="microcreditclientApp.bank.home.createLabel">Create new Bank</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('microcreditclientApp.bank.home.search')}
                />
        ...
        {bankList && bankList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="microcreditclientApp.bank.createdBy">Created By</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="microcreditclientApp.bank.modifiedBy">Modified By</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="microcreditclientApp.bank.home.notFound">No Banks found</Translate>
            </div>
          )
        )}
      </div>
