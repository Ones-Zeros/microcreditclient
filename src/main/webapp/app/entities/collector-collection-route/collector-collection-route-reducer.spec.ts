...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './collector-collection-route.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLLECTORCOLLECTIONROUTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_COLLECTORCOLLECTIONROUTES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COLLECTORCOLLECTIONROUTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COLLECTORCOLLECTIONROUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COLLECTORCOLLECTIONROUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COLLECTORCOLLECTIONROUTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COLLECTORCOLLECTIONROUTE actions', async () => {
      const arg = 42666;
