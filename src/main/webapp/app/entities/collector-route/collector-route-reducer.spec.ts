...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLLECTORROUTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_COLLECTORROUTES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COLLECTORROUTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COLLECTORROUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COLLECTORROUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COLLECTORROUTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COLLECTORROUTE actions', async () => {
      const arg = 42666;
