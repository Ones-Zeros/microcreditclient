...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './customer-bank-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMERBANKINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CUSTOMERBANKINFOS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CUSTOMERBANKINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CUSTOMERBANKINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CUSTOMERBANKINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMERBANKINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CUSTOMERBANKINFO actions', async () => {
      const arg = 42666;
