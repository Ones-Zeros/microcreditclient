...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMERLOAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CUSTOMERLOANS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CUSTOMERLOAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CUSTOMERLOAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CUSTOMERLOAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMERLOAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CUSTOMERLOAN actions', async () => {
      const arg = 42666;
