...
export const CustomerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="microcreditclientApp.customer.delete.question">
        <Translate contentKey="microcreditclientApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
