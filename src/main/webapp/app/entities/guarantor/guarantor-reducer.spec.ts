...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GUARANTOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_GUARANTORS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GUARANTOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GUARANTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GUARANTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GUARANTOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GUARANTOR actions', async () => {
      const arg = 42666;
