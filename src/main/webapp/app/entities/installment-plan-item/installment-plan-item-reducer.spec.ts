...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './installment-plan-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTALLMENTPLANITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_INSTALLMENTPLANITEMS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSTALLMENTPLANITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSTALLMENTPLANITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INSTALLMENTPLANITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INSTALLMENTPLANITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSTALLMENTPLANITEM actions', async () => {
      const arg = 42666;
