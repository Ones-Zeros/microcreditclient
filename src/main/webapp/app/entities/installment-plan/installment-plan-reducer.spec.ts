...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTALLMENTPLAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_INSTALLMENTPLANS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSTALLMENTPLAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSTALLMENTPLAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INSTALLMENTPLAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INSTALLMENTPLAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSTALLMENTPLAN actions', async () => {
      const arg = 42666;
