...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOANMORTGAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_LOANMORTGAGES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOANMORTGAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOANMORTGAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOANMORTGAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOANMORTGAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOANMORTGAGE actions', async () => {
      const arg = 42666;
