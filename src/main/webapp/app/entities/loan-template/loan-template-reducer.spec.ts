...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOANTEMPLATE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_LOANTEMPLATES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOANTEMPLATE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOANTEMPLATE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOANTEMPLATE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOANTEMPLATE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOANTEMPLATE actions', async () => {
      const arg = 42666;
