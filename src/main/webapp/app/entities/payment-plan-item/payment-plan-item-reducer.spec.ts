...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './payment-plan-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTPLANITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PAYMENTPLANITEMS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENTPLANITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENTPLANITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PAYMENTPLANITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTPLANITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENTPLANITEM actions', async () => {
      const arg = 42666;
