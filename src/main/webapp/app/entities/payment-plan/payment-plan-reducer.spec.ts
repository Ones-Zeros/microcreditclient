...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTPLAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_PAYMENTPLANS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENTPLAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENTPLAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PAYMENTPLAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTPLAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENTPLAN actions', async () => {
      const arg = 42666;
