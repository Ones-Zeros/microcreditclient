...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLEBRAND_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_VEHICLEBRANDS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEHICLEBRAND actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEHICLEBRAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEHICLEBRAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLEBRAND actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEHICLEBRAND actions', async () => {
      const arg = 42666;
