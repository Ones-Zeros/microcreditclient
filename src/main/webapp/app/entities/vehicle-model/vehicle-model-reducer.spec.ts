...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLEMODEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_VEHICLEMODELS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEHICLEMODEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEHICLEMODEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEHICLEMODEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLEMODEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEHICLEMODEL actions', async () => {
      const arg = 42666;
