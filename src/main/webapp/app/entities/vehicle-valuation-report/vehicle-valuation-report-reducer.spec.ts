...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './vehicle-valuation-report.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLEVALUATIONREPORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_VEHICLEVALUATIONREPORTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEHICLEVALUATIONREPORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEHICLEVALUATIONREPORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEHICLEVALUATIONREPORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLEVALUATIONREPORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEHICLEVALUATIONREPORT actions', async () => {
      const arg = 42666;
