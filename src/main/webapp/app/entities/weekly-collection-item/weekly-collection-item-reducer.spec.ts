...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './weekly-collection-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEEKLYCOLLECTIONITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_WEEKLYCOLLECTIONITEMS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WEEKLYCOLLECTIONITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WEEKLYCOLLECTIONITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WEEKLYCOLLECTIONITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WEEKLYCOLLECTIONITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WEEKLYCOLLECTIONITEM actions', async () => {
      const arg = 42666;
