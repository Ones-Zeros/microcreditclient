...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './weekly-collection.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEEKLYCOLLECTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_WEEKLYCOLLECTIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WEEKLYCOLLECTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WEEKLYCOLLECTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WEEKLYCOLLECTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WEEKLYCOLLECTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WEEKLYCOLLECTION actions', async () => {
      const arg = 42666;
